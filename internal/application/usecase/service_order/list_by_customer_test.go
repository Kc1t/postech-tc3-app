...
func TestListServiceOrdersByCustomer_Execute_Success(t *testing.T) {
	...
	uc := NewListServiceOrdersByCustomer(repo)
...
func TestListServiceOrdersByCustomer_Execute_RepoError(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
