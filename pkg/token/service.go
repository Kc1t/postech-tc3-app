...
type Service interface {
	...
	GenerateAccessToken(u *entities.User, expiresIn time.Duration) (string, error)
...
func (s *jwtService) GenerateAccessToken(u *entities.User, expiresIn time.Duration) (string, error) {
	now := time.Now()
